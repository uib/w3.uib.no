 CKEDITOR.addTemplates('uib_templates',{
   ...
   templates:[{
    ...
    html: '<div class="uib-feature__portrait-image"><img src=" " width="100px" height="100px"><div class="uib-feature__media-info"><p>Bilde tekst kommer her.</p></div></div>'
   },{
    title: 'Normal image with text',
    image: 'NORMALBREDDEBILDE_MED_BILDETEKST.svg',
    description: 'This inserts a image with text below',
    html: '<div class="uib-feature__image"><img src=" " width="100px" height="100px"><div class="uib-feature__media-info"><p>Bilde tekst kommer her.</p></div></div>'
   },{
    ...
    html: '<div class="uib-feature__full-width-image"><img src=" " width="100px" height="100px"><div class="uib-feature__media-info"><p>Bilde tekst kommer her.</p></div></div>'
   }
  ]
});
