...
<?php if ($logo || $site_name): ?>
    <div class="header__wrapper header__wrapper__employee">
      <header class="header">
<?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="logo__link">
          <div class="employee_logo"></div>
        </a>
<?php endif; ?>
<?php if ($site_name): ?>
  <?php if ($title): ?>
          <div class="site-name">
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home">
              <span><?php print t("Employee pages at UiB"); ?></span>
            </a>
          </div>
  ...
  <?php endif; ?>
<?php endif; ?>
<?php print render($page['employee_header']); ?>
      </header>
...
<?php print render($page['employee_subheader']); ?>
    </div>
<?php endif; ?>
<?php if (!empty($area_menu)): ?>
    <nav id="main-menu" class="employee">
